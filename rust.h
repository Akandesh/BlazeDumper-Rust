...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F07280;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2F55040;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2F667E0;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2F45048;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F074F0;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x5D8; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x5E0; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x5E8; // bool
        ...
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x638; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x640; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x644; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x648; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x650; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t maxProjectileID = 0x658; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x65C; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x660; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x664; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x668; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x66C; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x670; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x674; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x678; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x680; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x688; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x68C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x690; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x698; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x6A0; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x6A8; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x6B0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x6B8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x6C0; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x6C8; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x6D0; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x6D8; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x6E0; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x6E8; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x6F0; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x6F8; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x700; // int
        constexpr ::std::ptrdiff_t reputation = 0x704; // int
        constexpr ::std::ptrdiff_t _displayName = 0x708; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x710; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x718; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x72C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x740; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x754; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x768; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x770; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x774; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x778; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x77C; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x780; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x784; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x788; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x78C; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x790; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x798; // BaseEntity
    } // namespace BasePlayer
