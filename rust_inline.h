...
namespace blazedumper {
    ...
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3474B90;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3489F30;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x345AAB0;
