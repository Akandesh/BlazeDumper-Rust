...
namespace blazedumper {
    ...
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3A15528;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x39DA4A8;
