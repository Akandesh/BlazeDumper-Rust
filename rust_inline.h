...
namespace blazedumper {
    ...
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2EF8F20;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2F0A650;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2EE9858;
